...
public class State {
	...
	static{
		...
		State lala1L 	= new State(1, false);
		State lala1La	= new State(11, true);
		State lala2		= new State(2, true);
		State lala3L	= new State(3, false);
		State lala3La	= new State(13, true);
		State lala4		= new State(4, true);
		State lala5L	= new State(5, false);
		State lala5La	= new State(15, false);
		State lala6		= new State(6, false);
		State lala7L	= new State(7, false);
		State lala7Li	= new State(17, true);
		State lala8		= new State(8, true);
		
		DFA_LALA.addNext('L', lala1L);
		lala1L.addNext('a', lala1La);
		lala1La.addNext('a', lala1La);
		lala1La.addNext(' ', lala2);
		lala1La.addNext('L', lala3L);
		lala2.addNext(' ', lala2);
		lala2.addNext('L', lala3L);
		lala3L.addNext('a', lala3La);
		lala3La.addNext('a', lala3La);
		lala3La.addNext(' ', lala4);
		lala3La.addNext('L', lala5L);
		lala4.addNext(' ', lala4);
		lala4.addNext('L', lala5L);
		lala5L.addNext('a', lala5La);
		lala5La.addNext('a', lala5La);
		lala5La.addNext(' ', lala6);
		lala5La.addNext('L', lala7L);
		lala6.addNext(' ', lala6);
		lala6.addNext('L', lala7L);
		lala7L.addNext('i', lala7Li);
		lala7Li.addNext(' ', lala8);
		lala8.addNext(' ', lala8);
